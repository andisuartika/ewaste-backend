...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
            <button class="button text-white bg-theme-1 shadow-md mr-2">Tambahkah Data Sampah</button>
            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                        ...
                        <tr class="intro-x">
                            <td class="w-40">
                                <div class="flex">
                                    <div class="w-10 h-10 image-fit zoom-in">
                                        <img alt="Midone Laravel Admin Dashboard Starter Kit" class="tooltip rounded-full" src="{{ asset('dist/images/preview-1.jpg')}}" title="Uploaded at 03-06-2022">
                                    </div>
                            ...
                            <td>
                                <a href="" class="font-medium whitespace-no-wrap">Organik</a>
