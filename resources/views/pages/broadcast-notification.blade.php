                            ...
                            <div class="inbox__item inbox__item--active inline-block sm:block text-gray-700 bg-gray-100 border-b border-gray-200">
                                <div class="flex px-5 py-3">
                                    <div class="w-56 flex-none flex items-center mr-10">
                                        ...
                                        <div class="inbox__item--sender truncate ml-3">Nasabah</div>
                                    </div>
                                    <div class="w-64 sm:w-auto truncate">
                                        <span class="inbox__item--highlight">Lorem ipsum dolor sit amet consectetur adipisicing elit.</span> Lorem ipsum dolor sit amet
                                    </div>
                                    <div class="inbox__item--time whitespace-no-wrap ml-auto pl-10">12-03-2022 15:00</div>
                                </div>
                            </div>
                        </div>
